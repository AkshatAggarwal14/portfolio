...
export const site = {
  ...
  work: [
    ...
    { name: 'NITH-Announcements', slug: 'nith-announcements', title: 'NITH Announcements', description: 'HTTP API serving NIT Hamirpur announcements, built to feed Discord bots and other integrations.', url: 'https://github.com/AkshatAggarwal14/NITH-Announcements', language: 'Python', stack: ['Python', 'HTTP API'], details: ['Scrapes announcements from the NIT Hamirpur website and serves them over HTTP, split cleanly into scraper and server modules.', 'Designed as a backend for Discord bots: any client polls one endpoint instead of scraping HTML itself.', 'Built to be hosted, so campus communities can plug announcements into bots and dashboards with a single URL.'] },
    { name: 'CP-Badges', slug: 'cp-badges', title: 'CP Badges', description: 'Self-hosted API serving competitive-programming rating badges for READMEs and portfolios.', url: 'https://github.com/AkshatAggarwal14/CP-Badges', language: 'Python', stars: 2, stack: ['Python', 'Deta Micros', 'SVG badges'], details: ['Revived the dead upstream CP-Badges service by re-hosting the API on Deta micros.', 'Endpoints cover Codeforces, CodeChef, AtCoder, TopCoder, Yukicoder, URI, and LeetCode, keyed by username.', 'Badge color tracks each max rating, following the color policy of the platform it represents.', 'Supports logo badges via a query flag and custom link targets for clickable README badges.'] },
  ],
  resume: {
