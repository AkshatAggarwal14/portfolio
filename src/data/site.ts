...
export const site = {
  ...
  work: [
    { name: 'react-wordle', title: 'React Wordle', description: 'A Wordle clone built with React.', url: 'https://github.com/AkshatAggarwal14/react-wordle', language: 'JavaScript', demo: 'https://wordle-with-react.netlify.app/' },
    { name: 'resume', title: 'Resume', description: 'Resume published as a website, generated from TeX.', url: 'https://github.com/AkshatAggarwal14/resume', language: 'TeX', demo: 'https://akshataggarwal14.github.io/resume/' },
    { name: 'RFID-Attendance-system', title: 'RFID Attendance System', description: 'An RFID-based attendance system.', url: 'https://github.com/AkshatAggarwal14/RFID-Attendance-system', language: 'JavaScript', stars: 2 },
    { name: 'CP-Badges', title: 'CP Badges', description: 'Badges for competitive-coding profiles, for READMEs and portfolios.', url: 'https://github.com/AkshatAggarwal14/CP-Badges', language: 'Python', stars: 2 },
    { name: 'NITH-Announcements', title: 'NITH Announcements', description: 'API serving NIT Hamirpur announcements, built for Discord bots and similar integrations.', url: 'https://github.com/AkshatAggarwal14/NITH-Announcements', language: 'Python' },
  ],
  resume: {
